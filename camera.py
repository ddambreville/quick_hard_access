...
class Camera(object):
    def __init__(self, videoDev ,name, cameraIndexName, resolutionName, colorSpaceName, fps):
        ...
        autoExposition = int(tools.readParameter("Configuration/parameters.cfg","Camera","AutoExposition"))
        saturation = int(tools.readParameter("Configuration/parameters.cfg","Camera","Saturation"))
        gain = int(tools.readParameter("Configuration/parameters.cfg","Camera","Gain"))
        exposure = int(tools.readParameter("Configuration/parameters.cfg","Camera","Exposure"))
